...
import { LayoutDashboard, Users, Activity, Loader2, Building2, Briefcase, ClipboardCheck, DownloadCloud } from "lucide-react";
...
const ADMIN_MENU_GROUPS: SidebarMenuGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      // The only path to an EMPLOYER account: approving here creates one.
